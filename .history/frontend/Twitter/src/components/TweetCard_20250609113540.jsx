            ...
            {expanded && (
              ...
              >
                {comments?.[tweet.post_id]?.map((comment) => (
                  <div
                    key={comment.comment_id}
                    className="flex justify-between items-start text-sm text-gray-300 bg-gray-800 p-2 rounded-md"
                  >
                    <div className="flex-1">
                      ...
                      {editingCommentId === comment.comment_id ? (
                        <textarea
                          className="w-full mt-1 p-1 bg-transparent border border-gray-600 rounded-md"
                          value={editedCommentText}
                          onChange={(e) =>
                            setEditedCommentText(e.target.value)
                          }
                ...
                >
                  <input
                    ...
                    className="flex-1 p-2 bg-transparent border border-gray-600 rounded-md text-white"
                  />
                  <button
                    type="submit"
