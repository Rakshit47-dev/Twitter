        ...
        <div className="flex-1">
          ...
          <AnimatePresence>
            {expanded && (
              ...
              >
                {comments?.[tweet.post_id]?.map((comment) => (
                  <div key={comment.comment_id} className="text-sm text-white flex justify-between items-start border p-2 rounded-md bg-gray-800">
                    {editingCommentId === comment.comment_id ? (
                      <>
                        <textarea
                          value={editedCommentText}
                          ...
                          className="bg-transparent border p-1 rounded-md w-full mr-2"
                        />
                ...
                >
                  <input
                    ...
                    className="flex-1 bg-transparent border-b border-gray-600 focus:outline-none text-white p-1"
                    placeholder="Write a comment..."
                  />
                  <button type="submit" className="text-blue-400 ml-2">
                    Post
                  </button>
                </form>
              </motion.div>
